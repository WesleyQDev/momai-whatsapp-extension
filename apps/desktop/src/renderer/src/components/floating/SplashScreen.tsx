...
export default function SplashScreen({
  ...
  return (
    <div
      className={`fixed inset-0 z-[999] bg-[#03050a] flex items-center justify-center transition-all duration-700 ${
        ...
        <div className="text-center space-y-6 w-full">
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              {/* Dynamic Message */}
              <p className="text-xs text-gray-400 font-medium h-4 truncate">{initMessage}</p>
            </div>
          </div>
        </div>
